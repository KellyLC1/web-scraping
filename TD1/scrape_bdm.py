...
MAX_PAGES = 50  # Nombre de pages à scrapper

# Pages de listing à scrapper pour récupérer les URLs d'articles
LISTING_URLS = ['https://www.blogdumoderateur.com/articles/']
...
def is_article_url(url: str) -> bool:
    """Détermine si une URL est un article valide."""
...
def gather_all_links() -> list[str]:
    """Récupère tous les liens d'articles en paginant."""
    all_links = set()
...
def scrape_article(url: str):
    """Scrape un article et l'insère ou met à jour dans MongoDB."""
